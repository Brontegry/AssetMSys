...
public class AssetCategoryService implements IAssetCategoryService {
	...
	public void deleteAssetCategory() {
		...
		AssetCategory assetCategory = new AssetCategory();
		assetCategory = assetCategoryDao.findAssetCategoryById(2);
		assetCategoryDao.deleteAssetCategory(assetCategory);
	...
	public void findAssetCategory() {
		...
		for(AssetCategory assetCategory:list){
			System.out.println(assetCategory.getAcid()+"  "+assetCategory.getAccode()+"  "+assetCategory.getAcname()+"  "+assetCategory.getSupacid()+"  "+assetCategory.getSupacname());
		}
	}
